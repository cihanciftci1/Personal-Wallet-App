    ...
    function handleClick(transactionId, walletId) {
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => dispatch(deleteAndRevokeTransaction(transactionId, walletId)).then(()=>dispatch(getWallet(walletId)))
                },
                {
                    label: 'No',
                    onClick: () => dispatch(deleteTransaction(transactionId, walletId))
                }
            ]
        })
    }
